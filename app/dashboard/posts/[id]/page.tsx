    ...
    return (
        ...
        <div className="container mx-auto my-8 p-4">
            <div className="max-w-2xl mx-auto bg-white shadow-lg rounded-lg p-6">
                <h1 className="text-2xl font-bold mb-4">{post.start_location} to {post.end_location}</h1>
                <p className="text-gray-600 mb-2">Posted: {post.name} ({post.email}) at {post.post_time.toString().split(/:\d{2} G/)[0]}</p>
                <p className="text-gray-600 mb-2">Ride Time: {post.ride_time.toString().split(/:\d{2} G/)[0]}</p>
